    ...
    <div class="sl-toolbar pl-toolbar">
        <div class="sl-toolbar-meta">
            ...
            <?php /* Com varias pessoas no mesmo inventario, a coluna "Ja"
                     envelhece assim que a tela abre. */ ?>
            <button type="button" class="btn-ghost pl-atualizar" id="pl-atualizar"
                    title="Recarrega o que os outros operadores já contaram">Atualizar totais</button>
            <?php if ($avulso): ?>
